...
class LanguageService extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'discover': 'Discover Authentic India',
      'search_hint': 'Search crafts, regions, materials...',
    ...
    'hi': {
      ...
      'discover': 'प्रामाणिक भारत की खोज करें',
      'search_hint': 'शिल्प, क्षेत्र, सामग्री खोजें...',
    ...
    'te': {
      ...
      'discover': 'అసలైన భారతదేశాన్ని కనుగొనండి',
      'search_hint': 'కళలు, ప్రాంతాలు, పదార్థాలను వెతకండి...',
